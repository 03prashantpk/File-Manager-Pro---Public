...
// Sender info 
$mail->setFrom($email_add, 'Classroom Bucket - Enally');
$mail->addReplyTo($email_add, 'Classroom Bucket - Enally');
...
// Mail subject 
$mail->Subject = 'Notes Requested by - ' . $Requested_by_name;
...
<div class="thankyou-page">
    ...
    <div class="_body" style="margin: -70px 0 30px;">
      ...
      border-bottom: 60px #88D4C1 solid;">
            <h2>
                <strong>' . $Requested_by_name . '</strong> has requested ' . $Requested_for_subject . ' notes.
            </h2>
            <p>
              <b>Sender Message</b> <br>
              ' . $message . '<br><br>
              <center>
           <a style=" padding: 10px;
                     background-color: #fff5be; color: #424242;  box-shadow: 0 0 35px rgba(10, 10, 10,0.12);
    -moz-box-shadow: 0 0 35px rgba(10, 10, 10,0.12);
    -webkit-box-shadow: 0 0 35px rgba(10, 10, 10,0.12); border-bottom: 2px #88D4C1 solid; text-decoration: none;" href="https://enally.in/files-manager/upload/">Send Notes </a><br><br><p>Login Credentials will be shared on College portal or WhatsApp Group</p></center>
              <hr>
