            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-9">
                        <div class="card">
                            <div class="card-body">
                            <h3 style="text-align: center; font-weight: 600; padding-bottom:8px;">CA or MCQ's PQ- With or Answers</h3>
                            <hr>
                            <p class="text-success text-center">Class Assignments, Multiple Choice Question and Practice Questions - With or Without answer</p>
                            <p class="text-danger text-center">Note: This document has been uploaded after the exam duration. We do not promote cheat and other activity. (Doc has been uploaded for educational purpose only.)</p>
                            <p class="text-danger text-center" style="font-size: 14px;">Educational Purpose Only</p>
