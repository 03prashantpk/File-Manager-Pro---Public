...
<div class="table-responsive mt-3"  data-aos-duration="500">
    <table class="table table-striped table-hover table-sm mb-0"  data-aos-duration="500">
        <thead>
            <tr>
        ...
        <tbody>
            ...
            for ($index = 0; $index < $count; $index++) {
                ...
                if ($dirArray[$index] != '.' && $dirArray[$index] != '..' && $ext != "xml"  && $ext !== ""  && $ext !== "txt") {
                    ...
                    $fileowner = fileowner("gallery/$dirArray[$index]");
                    ...
                    printf('<tr  >
                            ...
                            <td><a href="gallery/' . $dirArray[$index] . '" id="downloadLink" class="count" download data-id="' . $dirArray[$index] . '"  "><i class="lni lni-download"></i></a> <span class="f-left">' . $dcount . ' downloads</span> </td>
                            <td>
                                ' . @$deleteopt . '
                            </td>
