...
//echo "Machine and OS Details: ",php_uname();
//echo "<br>";
...
<div class="thankyou-page">
    ...
    <div class="_body" style="margin: -70px 0 30px;">
      ...
      border-bottom: 60px #88D4C1 solid;">
            <h2>
                <strong>' . $Requested_by_name . '</strong> Today.
            </h2>
            <p>
              <b>Automated Message</b> <br>
              ' . $message . ' <br> <b> From: </b> <br> <b>City:</b> ' . $user_city .' <br> <b>State:</b> '.$user_state.' <br> <b>Country:</b> '.$user_country.' <br> <b> Using:</b> <br> <b>Device info:</b> '. gethostbyaddr($_SERVER['REMOTE_ADDR']) .' , '.gethostname().' <br> <br><br>
              <center>
