        ...
        printf('
                <div class="card-body">
                    <div class="card mb-3">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img style="padding: 5px;" src="https://i.pinimg.com/originals/dd/25/c4/dd25c43d93c9108c5c85fc5f223dfca9.gif" class="img-fluid rounded-start" alt="Project Thumb">
                            </div>
                            <div class="col-md-8" style="padding: 0px;">
                                <div class="card-body">
                                    <h5 class="card-title">' . $dirArray[$index] . '</h5>
