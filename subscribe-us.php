                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-9">
                        ...
                        <div class="card" style="border-bottom: 60px #fff5be solid;">
                            <h3 style="text-align: center; font-weight: 600; padding:20px;">Subscribe Us</h3>
                            <h5 style="text-align: center; font-weight: 600;">Subscribe to our newsletter to stay updated every moment!</h5>
                            <hr>
                            <div class="card-body center">
                                ...
                                <div class="subscribefor card-body center shadow">
                                    <h4>Get Email Notification On</h4>
                                    <hr>
                                    <ol>
                                        <li class="first">Get login Credential on Subscription</li>
                                        <li>New Notes Uploads</li>
                                        <li>New Project uploads</li>
                                        <li>Updating New Features</li>
                                        <li>Assignments Uploads</li>
                                        <li>New Software uploads</li>
                                        <li class="first">New Activities such as access to Google Notes, docs, ppts and much more .</li>
                                        <li>Recommended: Subscribe with Google email bacause Google doesn't allow to access its online resources with other emails.</li>
